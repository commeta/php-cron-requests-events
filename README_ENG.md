...
- define("CRON_LOG_ROTATE_MAX_SIZE", 10 * 1024 * 1024); // Maximum log size in MB
- define("CRON_LOG_ROTATE_MAX_FILES", 5); // Store a maximum of 5 archived log files
- define("CRON_URL_KEY", 'my_secret_key'); // Start key in URI
...
- 'timeout' => 0.04 // Blocking time, timeout for emergency start via fopen. Server response time * 10 depending on Linux Kernel Load Average\OPcache\FLOPS
...
### Links:
- [Nginx, Php-Fpm and what is it anyway?](https://perfect-inc.com/journal/nginx-php-fpm-i-chto-eto-voobshche/)
...
- [OPCache PHP extension overview](https://habr.com/en/company/vk/blog/310054/)
...
- [Nginx: how to check request processing time](https://codedepth.wordpress.com/2017/05/04/nginx-request-time/)
- [Tune memory and network stack in Linux](https://habr.com/ru/company/odnoklassniki/blog/266005/)
- [PHP 8: How to enable JIT](https://sergeymukhin.com/blog/php-8-kak-vklyucit-jit)
- [OPcache configuration options](https://www.php.net/manual/ru/opcache.configuration.php)
