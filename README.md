...
- при отключенных журналах в основном потоке нагрузка будет только по read(2) syscalls for the process, раз в секунду 1 вызов на задачу, только функции времени
