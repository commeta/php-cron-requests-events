...
- Работает на всех SAPI (кроме CLI): modApache, [PHP-FPM](https://perfect-inc.com/journal/nginx-php-fpm-i-chto-eto-voobshche/){:target="_blank"}, CGI, FastCGI. Версии PHP от 5.4 до 8.2.0
